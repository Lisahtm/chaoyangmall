...
<div class="section">
    <div class="container">
        <?php if(is_array($companyList)): $i = 0; $__LIST__ = $companyList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><div class="row service-wrapper-row ">
            <div class="col-sm-4">
                <div class="service-image">
                    <img src="<?php echo ($item["photo"]); ?>" alt="logo">
                </div>
            </div>
            <div class="col-sm-8">
                <h3><?php echo ($item["name"]); ?></h3>
                <p><pre><?php echo ($item["content"]); ?></pre></p>
            </div>
